    ...
    for k, filename in enumerate(filenames):
        ...
        while raw_video.isOpened():
            ...
            if args.grayscale:
                ...
                depth_mm = (origin_depth).astype(np.uint16)
                # write a 16-bit PNG sequence instead of the video
                gray_out_dir = os.path.join(args.outdir, "depth_raw_png")
                os.makedirs(gray_out_dir, exist_ok=True)
                filename = os.path.join(gray_out_dir, f"{frame_idx:06d}.png")
