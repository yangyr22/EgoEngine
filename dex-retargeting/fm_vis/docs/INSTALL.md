...
- The basic installation
  ```
  conda create -n venv_frankmocap python=3.10
...
## Folder hierarchy
- Once you sucessfully installed and downloaded all, you should have the following files in your directory, **make sure to put the extra_data folder under fm_vis/hand_detector/**:
    ```
    ./extra_data/
    ├── hand_module
