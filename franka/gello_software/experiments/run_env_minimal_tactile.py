...
class Args:
    ...
    data_dir: str = "/mnt/data2/dexmimic/workspace/franka/data"  # provide save dir here
    task: str = None
    # Dont change below
    bimanual: bool = False
    verbose: bool = False
...
def main(args):
    ...
    cam_dict = {}
    cam_config_dict = None # {"agentview": {"sn" : "001039114912", "type": "Kinect"}}
    # cam_config_dict = {
    #     "shoulderview_left": {"sn" : args.shoulderview_left_sn, "type": "Zed"},
    #     # "shoulderview_right": {"sn": args.shoulderview_right_sn, "type": "Zed"}
    # }
    ...
    robot_client = PandaRobot("OSC_POSE", gripper_type="franka") # gripper_type="robotiq")
