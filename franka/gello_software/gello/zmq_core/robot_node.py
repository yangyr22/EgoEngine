    ...
    def serve(self) -> None:
        ...
        while not self._stop_event.is_set():
            try:
                ...
                elif method == "_get_eef_pose_from_jointpos_as_tuple":
                    result = self._robot._get_eef_pose_from_jointpos_as_tuple(**args)
                else:
...
class ZMQClientRobot(Robot):
    ...
    def _get_eef_pose_from_jointpos_as_tuple(self, joint_positions):
        ...
        """
        request = {
            "method": "_get_eef_pose_from_jointpos_as_tuple",
