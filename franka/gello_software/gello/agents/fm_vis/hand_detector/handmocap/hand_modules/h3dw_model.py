...
class H3DWModel(object):
    ...
    def get_smplx_output(self, pose_params, shape_params=None):
        ...
        pred_joints_3d_unshift = hand_output['hand_joints']
        return pred_verts, pred_joints_3d, pred_joints_3d_unshift, hand_rotation
    ...
    def forward(self):
        ...
        self.pred_verts, self.pred_joints_3d, self.pred_joints_3d_unshift, self.rotation= self.get_smplx_output(self.pred_pose_params, self.pred_shape_params)
    ...
    def get_pred_result(self):
        pred_result = OrderedDict(
            ...
            pred_joints_3d_unshift=self.pred_joints_3d_unshift.cpu().numpy(),
            pred_hand_rotation=self.rotation.cpu().numpy(),
        )
        return pred_result
